...
namespace KirosEngine3.Math.Exceptions
{
    ...
    {
        /// <summary>
        /// Initialize a new _instance of the UndefinedMathOperationException.
        /// </summary>
        public UndefinedMathOperationException() : base() { }

        /// <summary>
        /// Initialize a new _instance of the UndefinedMathOperationException with the specified message.
        /// </summary>
        /// <param name="message">The message for the exception.</param>
        public UndefinedMathOperationException(string message) : base(message) { }

        /// <summary>        
        /// Initialize a new _instance of the UndefinedMathOperationException with the specified message, and a reference to the inner
